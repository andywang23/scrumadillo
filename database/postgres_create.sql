...
ALTER TABLE public.user ADD CONSTRAINT "user_fk0" FOREIGN KEY ("boardId") REFERENCES public.board("_id");
ALTER TABLE public.stack ADD CONSTRAINT "stack_fk0" FOREIGN KEY ("name") REFERENCES public.techInStack("stackName");
ALTER TABLE public.board ADD CONSTRAINT "board_fk0" FOREIGN KEY ("stackId") REFERENCES public.stack("_id");
ALTER TABLE public.tech ADD CONSTRAINT "tech_fk0" FOREIGN KEY ("name") REFERENCES public.techInStack("techName");
ALTER TABLE public.tech ADD CONSTRAINT "tech_fk0" FOREIGN KEY ("name") REFERENCES public.todo("tech");
ALTER TABLE public.techInStack ADD CONSTRAINT "techInStack_fk0" FOREIGN KEY ("techName") REFERENCES public.tech("name");


-- todo > tech > techinstack > stack > board > user
